...
void abs_s2_mission_execute()
{
	...
	case 1:
		abs_drive(BACKWARD, E_IR_DETECT, 3, 40, true, true);
		PlayTone(200,20);
		...
		wait1Msec(1000);
		abs_drive(FORWARD, E_ANGLE, /*distance in cm*/6, 50, true, true);
		wait1Msec(500);
	...
	case 2:
		...
		abs_drive(BACKWARD, E_ANGLE, /*distance in cm*/40, 50, true, true);
		servo[abdd] = g_abdd_up;
		wait1Msec(2000);
		servo[abdd] = g_abdd_down;
		break;
	...
	case 3:
		...
		abs_drive(BACKWARD, E_ANGLE, /*distance in cm*/65, 50, true, true);
		servo[abdd] = g_abdd_up;
		wait1Msec(2000);
		servo[abdd] = g_abdd_down;
		break;
	...
	case 4:
		...
		abs_drive(BACKWARD, E_ANGLE, /*distance in cm*/115, 50, true, true);
		servo[abdd] = g_abdd_up;
		wait1Msec(2000);
		servo[abdd] = g_abdd_down;
		break;
	...
	case 5:
		...
		abs_drive(BACKWARD, E_ANGLE, /*distance in cm*/140, 50, true, true);
		wait1Msec(2000);
		servo[abdd] = g_abdd_up;
		wait1Msec(2000);
		servo[abdd] = g_abdd_down;
	...
	case 6:
		...
		wait1Msec(200);
		abs_drive(FORWARD, E_ANGLE, 190, 50, true, true);
		abs_turn(COUNTERCLOCKWISE, POINT, TURN, 75, 60);
		abs_drive(FORWARD, E_ANGLE, 80, 50, true, true);
		break;

	case 7:
		abs_turn(COUNTERCLOCKWISE, POINT, TURN, 98, 60);
		wait1Msec(200);
		abs_drive(FORWARD, E_ANGLE, 87, 50, true, true);
