...
void abs_smoke_test_view(int test_num,int test_value1, int test_value2)
{
	...
	case 4: abs_cscreen("Grabbers","L   R   ","%1d   %1d   ",test_value1); break;
	...
	case 8: abs_cscreen("Pillow  ","slide   ","%1d       ",test_value1); break;
	case 9: abs_cscreen("EOPD    ","servo   ","%1d       ",test_value1); break;
	}
}
