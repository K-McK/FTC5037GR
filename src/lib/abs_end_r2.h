...
void abs_end_r2(int delay, int lift_speed)
{
	...
	if(g_auto_grabber_selection_ramp_options == SUB_SELECTION_RAMP_STOP) abs_drive(FORWARD, E_ANGLE, 80, 50, true, true);
	else abs_drive(FORWARD, E_ANGLE, 130, 50, true, true);
}
