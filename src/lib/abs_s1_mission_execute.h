...
void abs_s1_mission_execute()
{
	...
	case 0:
		...
		abs_drive(FORWARD, E_ANGLE, /*distance in cm*/600, 50, true, true);
		break;
	...
	case 1:
		...
		abs_drive(FORWARD, E_IR_DETECT, 7, ((50*INT_ANGLE_SENSOR_CIRCUMFERENCE)-HTANGreadAccumulatedAngle(angle_sensor)), true, false);
		PlayTone(200,20);
		wait1Msec(1000);
	...
	case 2:
		...
		abs_drive(FORWARD, E_ANGLE, /*distance in cm*/150, 50, true, false);
		wait1Msec(2000);
		servo[abdd] = g_abdd_up;
		wait1Msec(2000);
		servo[abdd] = g_abdd_down;
	...
	case 3:
		...
		abs_drive(FORWARD, E_ANGLE, /*distance in cm*/125, 50, true, false);
		servo[abdd] = g_abdd_up;
		wait1Msec(2000);
		servo[abdd] = g_abdd_down;
		break;
	...
	case 4:
		...
		abs_drive(FORWARD, E_ANGLE, /*distance in cm*/75, 50, true, false);
		servo[abdd] = g_abdd_up;
		wait1Msec(2000);
		servo[abdd] = g_abdd_down;
		break;
	...
	case 5:
		...
		abs_drive(FORWARD, E_ANGLE, /*distance in cm*/50, 50, true, false);
		servo[abdd] = g_abdd_up;
		wait1Msec(2000);
		servo[abdd] = g_abdd_down;
		break;
	...
	case 6:
		...
		wait1Msec(200);
		abs_drive(FORWARD, E_ANGLE, 190, 50, true, false);
		abs_turn(CLOCKWISE, POINT, TURN, 75, 60);
		abs_drive(FORWARD, E_ANGLE, 80, 50, true, false);
		break;

	case 7:
		abs_turn(COUNTERCLOCKWISE, POINT, TURN, 98, 60);
		wait1Msec(200);
		abs_drive(FORWARD, E_ANGLE, 87, 50, true, false);
