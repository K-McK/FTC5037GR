/**
*
*  @file abs_calibrate_light.h
*
*  @brief  Calibrates the light sensor
*
*  @param None n/a
*
...
task abs_calibrate_light()
{
	...
	abs_dlog(__FILE__ ,"Captured Data", "iteration", i, "avg_light_reading", avg_light_reading, "min_light_reading", min_light_reading,"max_light_reading", max_light_reading);
