...
int position1 ()//go here
{
	...
	leftAngle = 60;
	int column = 0;
	GyroSonar_moveV2(0, SIDE_BACK, 102, 116, -50,true, true, CONSTANT);//(int time, int WhichSensors, int distanceX, int distanceY, int power,bool StopWhenDone, bool adjust, bool ConstOrRel
	StopRobot();
	column = IR_Bearing;
	StopRobot();
	wait1Msec(200);
	Gyro_TurnV2(5,10,CONSTANT);
	wait1Msec(200);
	GyroTimeS_moveV2(1250,40,false,true,false,CONSTANT);
	StopRobot();
	...
	if(sawLine)
	{
		...
		//GyroTimeS_moveV2(8000,12,true,true,false,false);
		//StopRobot();
		GyroDrive(8000,rightAngle,15,true,true);
		StopRobot();
		GyroDrive(8000,leftAngle,15,true,true);
		StopRobot();
	}
	else
	{
...
int position2 ()
{
	rightAngle = 300;
	leftAngle = 150;
	GyroSonar_moveV2(0, BACK, 106, 120, -48,true, true, CONSTANT);
	column = IR_Bearing;
	GyroTimeS_moveV2(740,-40,false,true,true,CONSTANT);
	moveLightServo(DOWN);
	wait1Msec(1000);
	...
	{
		GyroDrive(8000,rightAngle,30,true,true);
		GyroDrive(8000,leftAngle,20,true,true);
	...
	{
		GyroDrive(8000,leftAngle,30,true,true);
		GyroDrive(8000,rightAngle,20,true,true);
		//GyroTimeS_moveV2(8000,-15,true,true,false,false);
...
int opponentRight ()
{
	rightAngle = 120;
	leftAngle = 330;
	GyroSonar_moveV2(0, BACK, 100, 122, -45,true, true, CONSTANT);
	StopRobot();
	GyroTime_moveV2(710,-40,true,true,REL);
	Gyro_TurnV2(85,-24,CONSTANT);
	GyroTime_moveV2(1820,-35,true,true,REL);
	moveLightServo(DOWN);
	wait1Msec(1000);
	bool sawLine = Gyro_TurnV2(35,-28,REL);
	...
	//GyroTimeS_moveV2(8000,15,true,true,false,false);
	StopRobot();
	GyroTimeS_moveV2(100,-26,false,true,false,false);
	GyroTime_moveV2(2000,-30,true,true,REL);
	StopRobot();
	return (column);
}
...
int opponentLeft ()
{
	...
	GyroSonar_moveV2(0, BACK, 100, 122, -45,true, true, CONSTANT);
	StopRobot();
	GyroTime_moveV2(520,-40,true,true,REL);
	Gyro_TurnV2(84,25,CONSTANT);
	GyroTime_moveV2(1500,-35,true,true,REL);
	moveLightServo(DOWN);
	wait1Msec(1000);
	bool sawLine = Gyro_TurnV2(35,30,REL);
	GyroTime_moveV2(1000,-30,true,true,REL);
...
task main()
{
	...
	case 19:
		GyroSonar_moveV2(0, BACK, 100, 30, -50,true, true, CONSTANT);
		sawOpponent = GyroSonar_moveV2(0, BACK, 100, 40, -50,true, true, CONSTANT);
		StopRobot();
	...
	case 20:
		...
		GyroSonar_moveV2(0, BACK, 100, 112, -50,true, true, CONSTANT);
		break;
	}
