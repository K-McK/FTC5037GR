...
task main()
{
	...
	while(true)
	{
		...
		//---------------------
		if(joy1Btn(5)) hypoteneuse = hypoteneuse/(float)3;
		if(joy1Btn(7)) hypoteneuse = hypoteneuse/(float)5;
		//---------------------
		...
		if (joy1Btn(3)) rotation_factor=25;			// clockwise rotation
			if (joy1Btn(2)) rotation_factor=-25;		// counter clockwise rotation
			speed_limit-=abs(rotation_factor);

		//=====================================================================
		// use the buttons to reset the cost heading
		//=====================================================================
		if(joy1Btn(9))
			{
				constHeading = 0;
		...
		nxtDisplayBigTextLine(6, "%03.0f %03.0f",LR_speed, hypoteneuse); //RR_speed);
	}
}
