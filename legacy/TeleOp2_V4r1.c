...
task main()
{
	...
	while(true)
	{
		...
		else hypoteneuse = hypoteneuse/(float)3;
		//---------------------
		...
		{
			LF_speed = cosDegrees(LF_angle-drive_angle)*drive_speed;
			RF_speed = cosDegrees(RF_angle-drive_angle)*drive_speed;
			LR_speed = cosDegrees(LR_angle-drive_angle)*drive_speed;
			RR_speed = cosDegrees(RR_angle-drive_angle)*drive_speed;
		}
		...
		if(joy2Btn(4)) // up
		{
			grabbers_position = grabbersUp;
			//servo[right_servo] = 180;
			//servo[left_servo] = 0;
		}
		if(joy2Btn(3)) // mid
		{
			grabbers_position = grabbersMid;
			//servo[right_servo] = 90;
			//servo[left_servo] = 90;
		}
		if(joy2Btn(2)) // down
		{
			grabbers_position = grabbersDown;
			//servo[right_servo] = 0;
			//servo[left_servo] = 180;
		}
	}
