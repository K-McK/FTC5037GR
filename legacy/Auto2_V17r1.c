...
int position1 ()
{
	...
	if(sawLine)
	{
		...
		//GyroTimeS_moveV2(8000,-15,true,true,false,false);
		GyroDrive(8000,200,30,true,true);
		GyroDrive(8000,70,20,true,true);
	}
	else
	{
		//GyroTimeS_moveV2(8000,-15,true,true,false,false);
		//GyroTimeS_moveV2(8000,18,true,true,false,false);
		GyroDrive(8000,70,30,true,true);
		GyroDrive(8000,200,20,true,true);
	}
...
int position2 ()
{
	GyroSonar_moveV2(0, BACK, 106, 114, -48,true, true, CONSTANT);
	column = IR_Bearing;
...
int opponentRight ()
{
	...
	StopRobot();
	GyroTime_moveV2(500,-35,true,true,REL);
	Gyro_TurnV2(86,-28,CONSTANT);
	...
	//GyroTimeS_moveV2(8000,15,true,true,false,false);
	StopRobot();
	GyroTime_moveV2(2000,-40,true,true,REL);
	StopRobot();
	return (column);
}
...
void leftPeg2()
{
	...
	//GyroTimeS_moveV2(700,30,false,true,true,false);//(int time, int power, bool light,bool StopWhenDone, bool adjust, bool ConstOrRel)
	GyroDrive(600,70,30,false,true);
	//---------------------
	//GyroTime_moveV2(120,-30,true,false,false);
	//GyroTimeS_moveV2(8000,16,true,true,false,false);
	GyroDrive(8000,70,22,true,true);
	//---------------------
	//GyroTimeS_moveV2(8000,-20,true,true,false,false);
	//GyroDrive(8000,200,50,true,true);
	//---------------------
	//GyroTimeS_moveV2(160,-20,false,true,false,false);
	GyroDrive(580,200,30,false,true);
	//---------------------
...
void rightPeg2()
{
	...
	//GyroTimeS_moveV2(700,-30,false,true,true,false);//(int time, int power, bool light,bool StopWhenDone, bool adjust, bool ConstOrRel)
	GyroDrive(700,200,60,false,false);
	//-----------------------
	GyroTime_moveV2(400,-30,true,false,false);
	//GyroTimeS_moveV2(8000,-16,true,true,false,false);
	GyroDrive(8000,200,21,true,true);
	//-----------------------
	GyroTimeS_moveV2(8000,20,true,true,false,false);
