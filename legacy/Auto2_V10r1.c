...
task main()
{
	...
	switch(MissionNumber)						// now go run whichever mission wqe have been asked to run
	{
		//================================================
	...
	case 1:
		...
		{
		case 1:
			GyroTimeS_moveV2(300,30,false,true,false,false);
	...
	case 2:
		...
		break;
		//================================================
		// start on the right side of the blue dispenser and delivers to B and returns to the blue dispencer
		//================================================
	...
	case 3:
		...
		GyroTimeS_moveV2(120,-15,false,true,false,false);
		wait1Msec(1500);
		servo[shoulder] = SHOULDER_UP;
		wait1Msec(2000);
		servo[wrist] = WRIST_OPEN;
		...
		break;
		//================================================
		// start on the right side of the blue dispenser and delivers to B and returns to the red dispencer
		//================================================
	...
	case 4:
		...
		break;
		//================================================
		// start on the right side of the blue dispenser and delivers to the left column, then stops
		//================================================
	case 5:
		...
		break;
		//================================================
		// start on the right side of the blue dispenser and delivers to the right column
		//================================================
	case 6:
	...
	case 7:
		...
		GyroSonar_moveV3(8000, SIDE_BACK, 50, 90, 40,180,true, true, REL);
		StopRobot();
		//wait1Msec(2000);
		//Gyro_TurnV2(45,-15,REL);
		//StopRobot();
		wait1Msec(2000);
		GyroSonar_moveV3(8000, ByTIME, 50, 90, 40,135,true, true, REL);
		//GyroTime_moveV2(2400,-30,true,false,REL);
		StopRobot();
		wait1Msec(5000);
		break;
