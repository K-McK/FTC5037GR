	...
	while(true)
	{
		...
		case mainScreen:
			...
			case 14:
				...
				nxtDisplayBigTextLine(2, "servo");
				break;
			case 15:
				nxtDisplayBigTextLine(0, "Demo");
				nxtDisplayBigTextLine(2, "RUN");
	...
	while(true)
	{
		if(testRunning)
		{
			...
			case 3:
				...
				if(rightButton)
				{
					motor[lifterMotor] = 95;
					motor[lifterMotor2] = 95;
				}
				else if(leftButton)
				{
					motor[lifterMotor] = -50;
					motor[lifterMotor2] = -50;
				}
				else
				{
					motor[lifterMotor] = 0;
			...
			case 4:
				...
				{
				case grippersUp:
					servo[right_servo] = 240;
					servo[left_servo] = 0;
					break;
				case grippersMed:
					servo[right_servo] = 140;
					servo[left_servo] = 90;
					break;
				case grippersDown:
					servo[right_servo] = 50;
			...
			case 14:
				...
				{
					while(leftButton) {}
					extraServoValue = extraServoValue-15;
				}
				else if (rightButton)
				{
					while(rightButton) {}
