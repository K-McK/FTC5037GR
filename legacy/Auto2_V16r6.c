...
{
	int column = 0;
	GyroSonar_moveV2(0, SIDE_BACK, 106, 109, -38,true, true, CONSTANT);//(int time, int WhichSensors, int distanceX, int distanceY, int power,bool StopWhenDone, bool adjust, bool ConstOrRel)
	column = IR_Bearing;
	...
	if(sawLine)
	{
		...
		//GyroTimeS_moveV2(8000,-15,true,true,false,false);
		GyroDrive(8000,215,30,true,true);
		GyroDrive(8000,55,30,true,true);
	}
	else
	{
		//GyroTimeS_moveV2(8000,-15,true,true,false,false);
...
int opponentRight ()
{
	GyroSonar_moveV2(0, BACK, 100, 124, -50,true, true, CONSTANT);
	GyroTime_moveV2(500,-35,true,true,REL);
	Gyro_TurnV2(88,-30,REL);
	GyroTime_moveV2(1500,-38,true,true,REL);
	moveLightServo(DOWN);
	wait1Msec(1000);
	bool sawLine = Gyro_TurnV2(40,-30,REL);
...
task main()
{
	...
	case 20:
		...
		GyroDrive(8000,260,25,true,true);
		break;
	}
