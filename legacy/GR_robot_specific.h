...
const int light_threshold = 34;				// the switchpoint on the light sensor for detecting lines // was 42
...
//==============================================================
const int MAXMISSIONS=20;							// the maximum number of selectable missions
